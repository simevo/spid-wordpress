					...
					<fieldset>
						...
						<table>
							<tr>
								<td>
									<label for="sp_name">
										<input name="sp_name" type="checkbox" 
										<?php
										if ( $sp_name ) {
											echo 'checked';}
										?>
								...
								<td>
									<label for="sp_familyName">
										<input name="sp_familyName" type="checkbox" 
										<?php
										if ( $sp_familyName ) {
											echo 'checked';}
										?>
							...
							<tr>
								<td>
									<label for="sp_expirationDate">
										<input name="sp_expirationDate" type="checkbox" 
										<?php
										if ( $sp_expirationDate ) {
											echo 'checked';}
										?>
										  id="sp_expirationDate">
										Data di scadenza identità
									</label>
								</td>
								<td>
									<label for="sp_placeOfBirth">
										<input name="sp_placeOfBirth" type="checkbox" 
										<?php
										if ( $sp_placeOfBirth ) {
											echo 'checked';}
										?>
							...
							<tr>
								<td>
									<label for="sp_countyOfBirth">
										<input name="sp_countyOfBirth" type="checkbox" 
										<?php
										if ( $sp_countyOfBirth ) {
											echo 'checked';}
										?>
								...
								<td>
									<label for="sp_dateOfBirth">
										<input name="sp_dateOfBirth" type="checkbox" 
										<?php
										if ( $sp_dateOfBirth ) {
											echo 'checked';}
										?>
							...
							<tr>
								<td>
									<label for="sp_gender">
										<input name="sp_gender" type="checkbox" 
										<?php
										if ( $sp_gender ) {
											echo 'checked';}
										?>
								...
								<td>
									<label for="sp_companyName">
										<input name="sp_companyName" type="checkbox" 
										<?php
										if ( $sp_companyName ) {
											echo 'checked';}
										?>
							...
							<tr>
								<td>
									<label for="sp_registeredOffice">
										<input name="sp_registeredOffice" type="checkbox" 
										<?php
										if ( $sp_registeredOffice ) {
											echo 'checked';}
										?>
										  id="sp_registeredOffice">
										Sede legale
									</label>
								</td>
								<td>
									<label for="sp_fiscalNumber">
										<input name="sp_fiscalNumber" type="checkbox" 
										<?php
										if ( $sp_fiscalNumber ) {
											echo 'checked';}
										?>
							...
							<tr>
								<td>
									<label for="sp_ivaCode">
										<input name="sp_ivaCode" type="checkbox" 
										<?php
										if ( $sp_ivaCode ) {
											echo 'checked';}
										?>
								...
								<td>
									<label for="sp_idCard">
										<input name="sp_idCard" type="checkbox" 
										<?php
										if ( $sp_idCard ) {
											echo 'checked';}
										?>
							...
							<tr>
								<td>
									<label for="sp_mobilePhone">
										<input name="sp_mobilePhone" type="checkbox" 
										<?php
										if ( $sp_mobilePhone ) {
											echo 'checked';}
										?>
								...
								<td>
									<label for="sp_digitalAddress">
										<input name="sp_digitalAddress" type="checkbox" 
										<?php
										if ( $sp_digitalAddress ) {
											echo 'checked';}
										?>
										  id="sp_digitalAddress">
										Domicilio digitale
									</label>
								</td>
							</tr>
							<tr>
								<td>
									<label for="sp_address">
										<input name="sp_address" type="checkbox" 
										<?php
										if ( $sp_address ) {
											echo 'checked';}
										?>
